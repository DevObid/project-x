    ...
    return (
        <div>
            <div className="flex">
                ...
                <div className="flex flex-col text-white		 p-3 h-[100vh]  bg-slate-900			 shadow-lg			 w-60 dark:bg-gray-50 dark:text-gray-800">
                    <div className="space-y-3">
                        ...
                        <div className="flex-1">
                            <ul className="pt-2 pb-4 space-y-1 text-sm">
                                ...
                                <li className="rounded-sm absolute bottom-0">
                                    <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
                ...
                <table className=" h-[100%] w-[100%]  text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr className="bg-white border-b  dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td className="px-6 py-4   "> <div className="h-[100%] w-[100%]  flex justify-center items-center"> <input className=' w-8 gap-r-[4px]	' placeholder='  00' /> <input className=' w-8 gap-6 ' placeholder='  00' /> TO <input className=' w-8 ' placeholder='  00' />  <input className=' w-8 ' placeholder='  00' /> </div></td>
                            <td className="px-6 py-4  "><input className=' w-8 gap-r-[4px]	' placeholder='  00' /> <input className=' w-8 gap-6 ' placeholder='  00' /> TO <input className=' w-8 ' placeholder='  00' />  <input className=' w-8 ' placeholder='  00' /></td>
                            <td className="px-6 py-4  "><input className=' w-8 gap-r-[4px]	' placeholder='  00' /> <input className=' w-8 gap-6 ' placeholder='  00' /> TO <input className=' w-8 ' placeholder='  00' />  <input className=' w-8 ' placeholder='  00' /></td>
