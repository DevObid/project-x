    ...
    return (
        <div>
            <Darkcontext.Provider value={isDarkMode}>
                <Sidebar />
                <div ref={refnav} className="w-[calc(100%)] h-16  right-0 flex items-center justify-center  bg-white border-gray-200 shadow-sm p-4 md:p-5 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400">
                    <div className="flex justify-between gap-16 items-center w-full">
                        <h3 className="ml-96">Hello Name</h3>
                        <img className="w-6 h-6 p-1 rounded-full ring-2 mr-[750px] ring-gray-300 dark:ring-gray-500" src="user.webp" alt="User" />
                        <button
                            type="button"
